                ...
                for (let row = 1; row <= seatLayer.rowCount; row++) {
                    for (let col = 1; col <= seatLayer.columnCount; col++) {
                        const item = {
                            ...
                            type: 'seat',
                            width: (seatStageWidth - seatLayer.spaceBetweenSeatsX) / seatLayer.columnCount,
                            height: (seatStageHeight - seatLayer.spaceBetweenSeatsY) / seatLayer.rowCount,
                            posX: seatLayer.stagePosXStart + seatLayer.spaceBetweenSeatsX * (col - 1) + seatWidth * (col - 1),
                            posY: seatLayer.stagePosYStart + seatLayer.spaceBetweenSeatsY * (row - 1) + seatHeight * (row - 1),
